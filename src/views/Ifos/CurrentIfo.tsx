...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from 'crox-uikit2.0'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal href="https://exchange.croxswap.com/#/swap" mr="16px">
              {TranslateString(999, 'Buy cake')}
            </LinkExternal>
            <LinkExternal href="https://exchange.croxswap.com/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
          ...
          <Text as="div" pt="16px">
            <Button
              as="a"
              variant="secondary"
              href="https://docs.croxswap.com/core-products/ifo-initial-farm-offering"
            >
